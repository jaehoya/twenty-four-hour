...
function Title() {
    ...
    return (
        <div className="w-full h-[4.57svh] md:h-[7.12svh] bg-white border-[1px] border-[#DAE0E9] rounded-[10px] flex items-center px-4 py-2 md:px-6 justify-between relative">
