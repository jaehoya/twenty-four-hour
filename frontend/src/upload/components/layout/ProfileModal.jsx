...
export default function ProfileModal() {
    ...
    // Store
    const { isOpenProfileModal, setIsOpenProfileModal, setIsOpenWithdrawModal } = useModalStore();
    ...
    return (
        <div className={`${isOpenProfileModal ? '' : 'hidden'} fixed w-full h-full top-0 left-0 bg-[#00000020] flex justify-center items-center z-100`}>
